...
type Crypto struct {
	...
	CurrentPrice uint64 `protobuf:"varint,4,opt,name=currentPrice,proto3" json:"currentPrice,omitempty"`
	BuyFee       uint64 `protobuf:"varint,5,opt,name=buyFee,proto3" json:"buyFee,omitempty"`
	SellFee      uint64 `protobuf:"varint,6,opt,name=sellFee,proto3" json:"sellFee,omitempty"`
}
...
func (x *Crypto) GetCurrentPrice() uint64 {
	if x != nil {
...
func (x *Crypto) GetBuyFee() uint64 {
	if x != nil {
		return x.BuyFee
	}
	return 0
...
func (x *Crypto) GetSellFee() uint64 {
	if x != nil {
		return x.SellFee
	}
	return 0
...
type CreateCryptoRequest struct {
	...
	CurrentPrice uint64 `protobuf:"varint,3,opt,name=currentPrice,proto3" json:"currentPrice,omitempty"`
}
...
func (x *CreateCryptoRequest) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *CreateCryptoRequest) GetCurrentPrice() uint64 {
	if x != nil {
		return x.CurrentPrice
	}
	return 0
...
func (x *CreateCryptoResponse) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_crypto_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9a,
	0x01, 0x0a, 0x06, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74,
	0x50, 0x72, 0x69, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x63, 0x75, 0x72,
	0x72, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x75, 0x79,
	0x46, 0x65, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x62, 0x75, 0x79, 0x46, 0x65,
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x65, 0x6c, 0x6c, 0x46, 0x65, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x07, 0x73, 0x65, 0x6c, 0x6c, 0x46, 0x65, 0x65, 0x22, 0x65, 0x0a, 0x13, 0x43,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x22,
	0x0a, 0x0c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x69,
	0x63, 0x65, 0x22, 0x26, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x72, 0x79, 0x70,
	...
	0x61, 0x72, 0x61, 0x6d, 0x2f, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x53, 0x65, 0x72,
...
var file_crypto_proto_goTypes = []interface{}{
	(*Crypto)(nil),               // 0: Crypto
	(*CreateCryptoRequest)(nil),  // 1: CreateCryptoRequest
	(*CreateCryptoResponse)(nil), // 2: CreateCryptoResponse
}
