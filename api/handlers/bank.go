...
func AddBankAccount(bankService internal.BankService) echo.HandlerFunc {
...
func ChargeAccount(bankService internal.BankService) echo.HandlerFunc {
	return func(c echo.Context) error {
...
func VerifyPayment(bankService internal.BankService) echo.HandlerFunc {
	return func(c echo.Context) error {
...
func WithdrawFromAccount(bankService internal.BankService) echo.HandlerFunc {
	return func(c echo.Context) error {
...
func GetAllTransactions(bankService internal.BankService) echo.HandlerFunc {
	return func(c echo.Context) error {
		user, bind := c.Get("user").(userModels.User)
		if !bind {
			response := models.NewErrorResponse("bank action failed", "bad user data")
...
func GetAllPayments(bankService internal.BankService) echo.HandlerFunc {
	return func(c echo.Context) error {
		user, bind := c.Get("user").(userModels.User)
		if !bind {
			response := models.NewErrorResponse("bank action failed", "bad user data")
