...
func OpenTicket(service internal.SupportService) echo.HandlerFunc {
...
func GetActiveTickets(service internal.SupportService) echo.HandlerFunc {
	return func(c echo.Context) error {
...
func GetTicketMessages(service internal.SupportService) echo.HandlerFunc {
	return func(c echo.Context) error {
...
func GetAllTickets(service internal.SupportService) echo.HandlerFunc {
	return func(c echo.Context) error {
		user, bind := c.Get("user").(userModels.User)
		if !bind {
...
func SendMessage(service internal.SupportService) echo.HandlerFunc {
	return func(c echo.Context) error {
...
func CloseTicket(service internal.SupportService) echo.HandlerFunc {
	return func(c echo.Context) error {
		ticketID := c.QueryParam("ticket_id")
